...
class OldCases extends StatelessWidget {
  ...
  final List<CaseData> caseDataList = [
    CaseData('CS001', 'WP BEA-1622', '2023:05:12'),
    CaseData('CS002', 'WP CAB-3716', '2023:05:11'),
    CaseData('CS003', 'WP CBE-3716', '2023:05:09'),
    CaseData('CS004', 'WP CBK-7516', '2023:05:02'),
  ];
...
class CaseData {
  ...
  CaseData(this.vehicleNo, this.caseNo, this.casedate);
}
