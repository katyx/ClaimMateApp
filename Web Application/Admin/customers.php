...
<head>
    ...
    <title>Customers - Claim Mate</title>
    ...
    <div class="container-xxl position-relative bg-none d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            ...
            <nav class="navbar navbar-light">
                    ...
                    <a href="customers.php" class="nav-item nav-link active"><i class="fa fa-users"></i>Customers</a>
                    <?php
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand casebox bg-light navbar-light sticky-top px-4 py-0">
                ...
                <input class="form-control border-0" name="search_value" type="search" placeholder="Search">
                    <div style="padding-left: 10px">
                        <button type="submit" name="searchbtn" class="btn btn-primary" style="background-color: #e3e3e3; border: none;">Search</button>
                    </div>
                </form>
            ...
            <div class="add row">
                <a class="addbutton btn btn-sm btn-primary" href="add-customer.php">Add Customer</a>
            </div>
                            ...
                            <tbody>
                                <?php
                                    if(isset($_POST['searchbtn'])){
                                        ...
                                        $sql = "SELECT * FROM `customers` WHERE CONCAT(nic,license,customername,mobile) LIKE '%$search_value%'";
                                        ...
                                        if(mysqli_num_rows($result) > 0){
                                            while($row = mysqli_fetch_array($result)){
                                                ...
                                                <td>$row[mobile]</td>
                                                <td><a class='btn btn-sm btn-primary' href='customer-details.php?nic=$row[nic]'>Details</a></td>
                                            </tr>
                                            ";
                                            }
                                        }else{
            ...
            <footer id="sticky-footer">
                ...
                <div class="text-center p-4">
                    © 2023 
                <a class="text-reset fw-bold" href="https://careu.live/">ClaimMate</a>
                - All Rights Reserved
                </div>
                <!-- Copyright -->
            </footer>
