                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="casebox bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <img src="images/total.png" alt="" style="width: 50px;">
                            <div class="ms-3">
                                <a href="cases.php">
                                    <?php
                                        $sql = "SELECT COUNT(caseid) AS count FROM `case`";
                                        $result = mysqli_query($conn, $sql);

                                        $row = mysqli_fetch_assoc($result);
                                        $count = $row['count'];
                                        echo "<p class='cases mb-2'>Total Cases</p>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="casebox bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <img src="images/resolved.png" alt="" style="width: 50px;">
                            <div class="ms-3">
                                <a href="attended-cases.php">
                                    <?php
                                        $sql = "SELECT COUNT(case when `status` ='Attended' then 1 end) AS Attended FROM `case`";
                                        $result = mysqli_query($conn, $sql);

                                        $row = mysqli_fetch_assoc($result);
                                        $count = $row['Attended'];
                                        echo "<p class='cases mb-2'>Attended Cases</p>
                                        <h6 class='mb-0'>$count</h6>";
                                    ?>
                                </a>
                            </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="casebox bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <img src="images/unresolved.png" alt="" style="width: 50px;">
                            <div class="ms-3">
                                <a href="non-attended-cases.php">
                                    <p class="cases mb-2">Non Attended</p>
                                    <?php
                                        $sql = "SELECT COUNT(case when `status` ='Non-Attended' then 1 end) AS nonattended FROM `case`";
                                        $result = mysqli_query($conn, $sql);

                                        $row = mysqli_fetch_assoc($result);
                                        $count = $row['nonattended'];
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="casebox bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <img src="images/todaycases.png" alt="" style="width: 50px;">
                            <div class="ms-3">
                                <a href="today-cases.php">
                                    <p class="cases mb-2">Today Cases</p>
                                    <?php
                                        $sql = "SELECT COUNT(case when `date` = CURDATE() then 1 end) AS todaycase FROM `case`";
                                        $result = mysqli_query($conn, $sql);
            ...
            <div class="container-fluid pt-4 px-4" >
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="casebox bg-light text-center rounded p-4" style="height: 330px;">
                            ...
                            <div class="caseboxtable table-responsive">
                                <table class="table text-start align-middle table-bordered table-hover mb-0">
                                    <tbody>
                                        <?php
                                            $sql = "SELECT * FROM `case` WHERE `date` = CURDATE()";
                                            $result = mysqli_query($conn, $sql);
                ...
                <div class="casebox bg-light text-center rounded p-4">
                    ...
                    <div class="casetable table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT * FROM `case` ORDER BY `caseid` DESC";
                                    $result = mysqli_query($conn, $sql);
    ...
    var myChart4 = new Chart(ctx4, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [<?php echo json_encode($acount)?>, 49]
            }]
        },
        options: {
            responsive: true
