...
<head>
    ...
    <title>User Details - Claim Mate</title>
                    ...
                    <div class="col-md-6">
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4" style="text-align: center;">
                                <h6 class="username mb-0"><b>Profile</b></h6>
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="col-md-6">
                        <div class="bg-light text-center rounded p-4">
                            <div class="row case-details">
                                ...
                                <div class="col-md-7">: <span><?php echo $_SESSION['id'];?></span> </div>
                           </div>
                           <div class="row case-details">
                                <div class="col-md-5">Employee Name</div>
                                <div class="col-md-7">: <span><?php echo $_SESSION['empname'];?></span> </div>
                            </div>
                           <div class="row case-details">
                                <div class="col-md-5">Username</div>
                                <div class="col-md-7">: <span><?php echo $_SESSION['user'];?></span></div>
                           </div>
                           <div class="row case-details">
                            <div class="col-md-5">User Type</div>
                            <div class="col-md-7">: <span><?php echo $_SESSION['usertype'];?></span></div>
                       </div>
                        </div>
                    </div>
                </div>
