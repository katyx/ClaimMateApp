...
<head>
    ...
    <title>Total Cases - Claim Mate</title>
                            ...
                            <tbody>
                                <?php
                                    if(isset($_POST['searchbtn'])){
                                        ...
                                        $sql = "SELECT * FROM `case` WHERE CONCAT(caseid,date,time,location,claim_no,vcl_no,drvr_nic,drvr_lno,fullname,address,mobno,cstm_nic,cstm_name) LIKE '%$search_value%' ORDER BY `caseid` DESC";
