...
<head>
    ...
    <title>System Users - Claim Mate</title>
    ...
    <div class="container-xxl position-relative bg-none d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="casebox bg-light text-center rounded p-4" style="height: 500px;">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0" style="padding-top: 30px;">System Users</h6>
                    </div>
                    <div class="systemuserstbl table-responsive">
                            ...
                            <tbody>
                                <?php
                                    if(isset($_POST['searchbtn'])){
                                        ...
                                        $sql = "SELECT * FROM `login` WHERE CONCAT(id,empname,username,usertype) LIKE '%$search_value%'";
                                        ...
                                        if(mysqli_num_rows($result) > 0){
                                            while($row = mysqli_fetch_array($result)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$row[username]</td>
                                                    <td>$row[usertype]</td>
                                                    <td><div class='dbtn'><a class='btn deletebutton' href='delete.php?id=$row[id]'>Delete</a></div></td>
                                                </tr>
                                                ";
                                            }
                                        }else{
